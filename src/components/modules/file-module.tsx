  ...
  return (
    <>
      {loadingStatus === 'loading' ? (
        <div className="fixed inset-0 z-50 !mt-0 flex flex-col items-center justify-center space-y-6 bg-gray-100 text-white dark:bg-gray-900">
          <H2>Analysing your file</H2>
          <div className="h-32 w-32 animate-spin rounded-full border-y-2 border-daren" />
        </div>
      ) : null}
